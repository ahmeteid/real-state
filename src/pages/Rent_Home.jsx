  ...
  return (
    <>
      <div className="properties-container">
        <div className="page-header">
          <h1>Homes for Rent</h1>
          <p>Find your perfect rental property from our available listings</p>
        </div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-section">
                ...
                <p>
                  This rental property is available immediately and offers
                  comfortable living in a great location. The property is
                  well-maintained and includes all essential amenities. Perfect
                  for individuals, couples, or small families looking for a
                  quality rental home.
                </p>
              </div>
              <div className="modal-section">
                ...
                >
                  <li>Available for immediate move-in</li>
                  <li>Security deposit required</li>
                  <li>Utilities may be included (contact for details)</li>
